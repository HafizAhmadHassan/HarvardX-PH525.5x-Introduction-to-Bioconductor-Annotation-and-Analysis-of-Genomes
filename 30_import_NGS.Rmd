...
Specifying what = "seq" when calling the scanBam() function will return the matching read sequences as a DNAStringSet.
...
```{r}
a<-sum(letterFrequency(reads[[1]]$seq, "GC")) 
```

```{r}
b<-sum(width(reads[[1]]$seq))
```
